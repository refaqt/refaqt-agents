...
Templates live in this kit under `bootstrap/docs/` and `templates/` (e.g. `templates/adr.md`). Each folder has a `README.md` index — **update it when adding a file**, or the entry becomes invisible.
