...
description: >-
  ...
  and belgian-corporate-law; not for securities determinations or tax filings.
---
# Token Engineering

Use this skill to **design token and incentive systems** that serve cooperative goals while fitting Belgian legal and fiscal reality. Read this skill together with `belgian-law`, `belgian-fiscal-tax`, and `belgian-corporate-law` before proposing any token architecture.
...
- Tax filings, rulings, or definitive treatment → `belgian-fiscal-tax`, human advisers
...
| Income & VAT | `belgian-fiscal-tax` | Taxable benefit at grant, vest, transfer, or redemption? |
...
6. **Regulatory screen:** MiCA, e-money, crowdfunding, FSMA — `european-law`, `legal-advice`.
7. **Governance fit:** Confirm GA/board authority for economic rights (`belgian-corporate-law`, `sociocracy`).
8. **Implementation:** Off-chain ledger vs on-chain (`web3-blockchain` fit test).
9. **Documentation:** Plain-language member explanation (FR/NL as needed — `belgian-law`).
10. **Review gate:** Accountant + counsel before public announcement.
...
- [ ] Treasury and issuance budget in `finance` forecast
...
| Tax and VAT on token events | `belgian-fiscal-tax` |
